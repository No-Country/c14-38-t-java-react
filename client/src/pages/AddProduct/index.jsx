          ...
          <div className=" bg-gray-100 sm:bg-white p-8 sm:pt-9 sm:pb-12 sm:rounded-xl flex flex-col sm:justify-center sm:align-baseline gap-5 absolute top-0 left-0 bottom-0 right-0 sm:relative w-full sm:w-auto h-full sm:h-auto overflow-auto sm:overflow-visible">
              ...
              <div className="flex flex-col-reverse gap-3 sm:gap-32 mx-4 sm:mx-auto sm:flex-row">
                  <div className="flex flex-col sm:w-1/2">
                      <div className='mb-1.5 sm:mb-3 font-sans font-medium text-base'>Nombre</div>
                      ...
                      <div className='mb-1.5 sm:mb-3 font-sans font-medium text-base'>Código</div>
                      <div className="mb-3 sm:mb-3 flex rounded-lg shadow-sm ring-1 ring-inset ring-custom-gray focus-within:ring-2 focus-within:ring-inset focus-within:ring-custom-blue sm:max-w-md sm:w-auto lg:w-screen">
                      ...
                      <div className='mb-1.5 sm:mb-3 font-sans font-medium text-base'>Descripción</div>
                      <div className="mb-3 sm:mb-3 flex rounded-lg shadow-sm ring-1 ring-inset ring-custom-gray focus-within:ring-2 focus-within:ring-inset focus-within:ring-custom-blue sm:max-w-md sm:w-auto lg:w-screen">
                      ...
                      <div className='mb-1.5 sm:mb-3 font-sans font-medium text-base'>Categoría</div>
                      <div className="mb-3 sm:mb-3 flex rounded-lg shadow-sm ring-1 ring-inset ring-custom-gray focus-within:ring-2 focus-within:ring-inset focus-within:ring-custom-blue sm:max-w-md sm:w-auto lg:w-screen" onClick={() => setIsCategoryModal(true)}>
                      ...
                      {isCategoryModal && (<AddCategory isCategoryModal={isCategoryModal} setIsCategoryModal={setIsCategoryModal} />)}
                      <div className='mb-1.5 sm:mb-3 font-sans font-medium text-base'>Proveedor</div>
                      <div className="mb-3 sm:mb-3 flex rounded-lg shadow-sm ring-1 ring-inset ring-custom-gray focus-within:ring-2 focus-within:ring-inset focus-within:ring-custom-blue sm:max-w-md sm:w-auto lg:w-screen" onClick={() => setIsSupplierModal(true)}>
                      ...
                      {isSupplierModal && (<AddSupplier isSupplierModal={isSupplierModal} setIsSupplierModal={setIsSupplierModal} />)}
                      <div className='mb-1.5 sm:mb-3 font-sans font-medium text-base'>Cantidad</div>
                      <div className="mb-3 sm:mb-3 flex rounded-lg shadow-sm ring-1 ring-inset ring-custom-gray focus-within:ring-2 focus-within:ring-inset focus-within:ring-custom-blue sm:max-w-md sm:w-auto lg:w-screen">
                  ...
                  <div className="flex flex-col sm:justify-center lg:justify-normal sm:pt-9 sm:w-1/2">
              ...
              <div className="flex justify-end gap-11 mx-3 mt-28 sm:mx-0 sm:mt-1">
